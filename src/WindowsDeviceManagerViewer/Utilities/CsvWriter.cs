...
namespace WindowsDeviceManagerViewer.Utilities
{
    ...
    internal class CsvWriter
    {
        ...
        public static void WriteWindowsDeviceInfoRecords(string outputCsvFile, List<WindowsDeviceInfo> windowsDeviceInfos)
        {
            ...
            swCsv.WriteLine($"\"{Resources.Strings.HostName}\",\"{Resources.Strings.UserName}\",\"{Resources.Strings.OSName}\",\"{Resources.Strings.OSBuildNumber}\",\"{Resources.Strings.OSVersion}\",\"{Resources.Strings.LastUpdate}\"");

            foreach (WindowsDeviceInfo info in windowsDeviceInfos)
            {
                swCsv.WriteLine($"\"{info.HostName}\",\"{info.UserName}\",\"{info.OSName}\",\"{info.OSBuildNumber}\",\"{info.OSVersion}\",\"{info.LastUpdate}\"");
            }
